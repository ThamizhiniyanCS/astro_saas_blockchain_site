    ...
    <section className="py-24 md:py-52 overflow-x-clip">
      <div className="container">
          ...
          <div className="inline-flex relative z-0">
            ...
            >
              <img
                ...
                alt=""
                className="absolute w-[calc(100%+100px)] max-w-none -z-10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 saturate[10%] brightness-[4%] hue-rotate-[240deg]"
              />
              <img
                src="/assets/images/icosahedron.png"
        ...
        <div className="flex flex-col items-center justify-center mt-40 md:mt-80 gap-4">
          <div className="h-10 w-5 outline outline-[5px] outline-fuchsia-500/10 inline-flex justify-center pt-2 rounded-full">
            <motion.div
